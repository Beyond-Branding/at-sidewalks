    ...
    <Layout footer={props.footer}>
      ...
      <section className="mx-auto px-6 py-12 text-gray-800 text-sm leading-relaxed container">
        <div className="space-y-6 mx-auto max-w-5xl">
          <h1 className="font-semibold text-lg">Accessibility</h1>

          <p className="text-sm">
            PLEASE READ THIS TERMS OF USE AGREEMENT (“TERMS OF USE”) CAREFULLY
            AS IT FORMS A BINDING LEGAL AGREEMENT BETWEEN YOU AND SIDEWALKS.
            SideWalks (“SideWalks”, “we”, or “us”) owns and operates the website
            made available to you at <strong>http://sidewalks.com</strong> (the
            ...
            Website (collectively, with the Products and Website, the “Service”
            or “Services”).
          </p>
          ...
          <p className="text-sm">
            ...
            Terms will either be listed in the Terms of Use or will be presented
            to you for your acceptance when you sign up to use the supplemental
            Service. If the Terms of Use are inconsistent with the Supplemental
            Terms, the Supplemental Terms shall control with respect to such
            Service. The Terms of Use and any applicable Supplemental Terms are
          ...
          <p className="text-sm">
            ...
            new Supplemental Terms will be made available from within, or
          ...
          <h2 className="mt-6 font-medium text-lg">
            Use of the Services and SideWalks Properties
          </h2>
          <p className="text-sm">
          ...
          <h3 className="mt-4 font-medium text-base">Updates</h3>
          <p className="text-sm">
          ...
          <h3 className="mt-4 font-medium text-base">Certain Restrictions</h3>
          <p className="text-sm">
            ...
            competitive website, application or service; (g) except as expressly
            stated herein, no part of SideWalks Properties may be copied,
            reproduced, distributed, republished, downloaded, displayed, posted
            or transmitted in any form or by any means; (h) you shall not take
            any action that imposes any unreasonable or disproportionately large
            load on the SideWalks Properties; (i) you shall not take any action
            in connection with your use of the SideWalks Properties which
            violates any applicable local, state, national or international law;
            (j) you shall not otherwise use the SideWalks Properties for any
            unlawful or abusive purposes, including posting or distribution of
            Malicious Code; and (k) you shall not remove or destroy any
            copyright notices or other proprietary markings contained on or in
            SideWalks Properties. Any unauthorized use of SideWalks Properties
            terminates the licenses granted by SideWalks pursuant to the Terms.
          </p>

          <h3 className="mt-4 font-medium text-base">Third-Party Materials</h3>
          <p className="text-sm">
          ...
          <h2 className="mt-6 font-medium text-lg">Registration</h2>

          <h3 className="mt-4 font-medium text-base">
          ...
          <h3 className="mt-4 font-medium text-base">Registration Data</h3>
          <p className="text-sm">
            ...
            Properties by minors. If you provide any information that is untrue,
            inaccurate, not current or incomplete, SideWalks has the right to
            suspend or terminate your Account and refuse any and all current or
            future use of SideWalks Properties.
          </p>
          ...
          <p className="text-sm">
            You acknowledge that all files, materials, data, text, audio, video,
            images or other content (“Content”) is the sole responsibility of
            the party from whom such Content originated. This means that you,
            and not SideWalks, are entirely responsible for all Content that you
            upload, post, e-mail, transmit or otherwise make available (“Your
            Content”), and that you and other users of SideWalks Properties, and
            not SideWalks, are similarly responsible for all Content they Make
            Available through SideWalks Properties.
          </p>

          <h2 className="mt-6 font-medium text-lg">Ownership</h2>
          <p className="text-sm">
          ...
          <h3 className="mt-4 font-medium text-base">Trademarks</h3>
          <p className="text-sm">
            ...
            trademarks of SideWalks and may not be used without permission.
            Other trademarks that appear on SideWalks Properties are the
          ...
          <h2 className="mt-6 font-medium text-lg">Third-Party Services</h2>
          <p className="text-sm">
          ...
          <h2 className="mt-6 font-medium text-lg">Product Purchase Terms</h2>

          <h3 className="mt-4 font-medium text-base">Products</h3>
          <p className="text-sm">
          ...
          <h3 className="mt-4 font-medium text-base">Payments</h3>
          <p className="text-sm">
          ...
          <h3 className="mt-4 font-medium text-base">Taxes</h3>
          <p className="text-sm">
          ...
          <h3 className="mt-4 font-medium text-base">Orders & Cancellations</h3>
          <p className="text-sm">
          ...
          <p className="text-sm">
            Risk of loss of the Product passes to you on delivery of the Product
            to the carrier. Claims against carriers for damage during shipping
            are your responsibility.
          </p>

          <h3 className="mt-4 font-medium text-base">Third Party Providers</h3>
          <p className="text-sm">
          ...
          <h3 className="mt-4 font-medium text-base">Refund Policy</h3>
          <p className="text-sm">
            ALL SALES ARE FINAL unless otherwise specified. SideWalks reserves
            the right to refuse returns.
          </p>

          <h3 className="mt-4 font-medium text-base">Price Adjustments</h3>
          <p className="text-sm">
            SideWalks does not offer price matches or sale adjustments unless
            specifically posted.
          </p>

          <h2 className="mt-6 font-medium text-lg">Indemnification</h2>
          <p className="text-sm">
            You agree to indemnify and hold SideWalks, its affiliates, officers,
            employees, agents and licensors harmless from losses, costs,
            liabilities and expenses (including reasonable attorneys’ fees)
            arising out of (a) content you post, (b) your use of or inability to
            use SideWalks Properties, (c) your violation of the Terms, (d) your
            violation of any rights of another party, or (e) your violation of
            applicable laws.
          </p>
          ...
          <h2 className="mt-6 font-medium text-lg">Limitation of Liability</h2>
          <p className="text-sm">
            ...
            NEGLIGENCE, FRAUD, OR OTHER LIABILITY THAT CANNOT BE EXCLUDED BY
            LAW.
          </p>

          <h2 className="mt-6 font-medium text-lg">Remedies</h2>
          <p className="text-sm">
          ...
          <h2 className="mt-6 font-medium text-lg">Term and Termination</h2>
          <p className="text-sm">
          ...
          <h2 className="mt-6 font-medium text-lg">International Users</h2>
          <p className="text-sm">
          ...
          <p className="text-sm">
            Please read the Arbitration Agreement in this Section carefully. It
            requires arbitration for most disputes and limits how you can seek
            relief. You may opt out of arbitration where the Terms permit and as
            specified below.
          </p>
          ...
          <h3 className="mt-4 font-medium text-base">
            Waiver of Jury Trial & Class Relief
          </h3>
          <p className="text-sm">
          ...
          <h2 className="mt-6 font-medium text-lg">General Provisions</h2>
          <p className="text-sm">
            <strong>Electronic Communications.</strong> Communications between
            you and SideWalks are electronic; you consent to receive
          ...
          <p className="text-sm">
            <strong>Force Majeure.</strong> SideWalks is not liable for delays
            or failures due to events outside reasonable control (acts of God,
          ...
          <p className="text-sm">
            <strong>Exclusive Venue & Governing Law.</strong> Where litigation
            is permitted, both parties agree matters will be litigated in courts
